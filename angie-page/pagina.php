...
<body>
    ...
    <section>
        ...
        <section id="gobierno">
            <div class="row" style="padding: 20px;">
                <div class="col-md-4">
                    <div class="card">
                        <img src="Imagenes/card1-gobierno.jfif" class="card-img-top" alt="Imagen 1">
                        <div class="card-body">
                            <h3 class="card-title" style="text-align: center;">Frases de orden</h3>
                            <p class="card-text" style="text-align: justify;">
                            <ul style="justify-content: flex-start;">
                                <li>Díaz Ordaz: “El orden público es responsabilidad del Estado y debe mantenerse a toda costa.”</li>
                                <li>Díaz Ordaz: “No permitiremos que intereses ajenos perturben la estabilidad del país.”</li>
                                <li>López Mateos: “El respeto a la ley es base indispensable para la convivencia social.”</li>
                            </ul>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="Imagenes/card2-gobierno.jfif" class="card-img-top" alt="Imagen 2">
                        <div class="card-body">
                            <h3 class="card-title" style="text-align: center;">Frases de paz social</h3>
                            <p class="card-text" style="text-align: justify;">
                            <ul style="justify-content: flex-start;">
                                <li>López Mateos: “La paz social se construye con justicia y bienestar para todos.”</li>
                                <li>López Mateos: “Nuestro objetivo es que cada mexicano tenga acceso a mejores condiciones de vida.”</li>
                                <li>Díaz Ordaz: “La tranquilidad de la nación es prioritaria frente a cualquier conflicto.”</li>
                            </ul>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="Imagenes/card3-gobierno.jfif" class="card-img-top" alt="Imagen 3">
                        <div class="card-body">
                            <h3 class="card-title" style="text-align: center;">Frases de progreso</h3>
                            <p class="card-text" style="text-align: justify;">
                            <ul style="justify-content: flex-start;">
                                <li>López Mateos: “El progreso de México debe traducirse en beneficios reales para el pueblo.”</li>
                                <li>López Mateos: “La industrialización es el camino hacia el desarrollo nacional.”</li>
                                <li>Díaz Ordaz: “El desarrollo económico requiere disciplina, trabajo y estabilidad.”</li>
                            </ul>
                            </p>
                        </div>
                    </div>
    ...
    <div style="text-align: center; padding: 20px;">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/GdL6jIcqBtw" title="Video informativo de los movimientos" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
</body>
